export default function Presentation() {
  ...
  <span className="font-bold text-black">Bouziane</span>, étudiant en alternance en préparation d'un diplôme de <span className="font-bold text-purple-600 underline">Master Architecte de Systèmes d'Information</span>. Passionné par l'informatique, je partage mes projets et mon parcours d'études.
  <br/>
