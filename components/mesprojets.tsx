    ...
    <div className="" id="projets">
      ...
      <div className="ml-[5%] mr-[5%]  grid grid-cols-1 md:grid-cols-2 gap-6 projects">
        ...
        <Project_card
          ...
          src="portfolio_php.png"
          descripton="Mon premier projet en PHP était un portfolio pour présenter mes travaux d'école. Bien que c'était mon premier projet en utilisant ce langage, j'ai appris énormément de choses. Malheureusement, le design n'était pas aussi bon que je l'aurais voulu, mais j'ai utilisé une API pour afficher les projets de manière efficace et interactive."
        />
                <Project_card
          list={["https://vectorwiki.com/images/PDA16__flutter.svg"]}
          name="Mon premier projet RPG Mobile"
          src="flutter_game.png"
          descripton="Mon premier projet en utilisant Flutter était un jeu de carte où un joueur pouvait se déplacer librement dans un environnement virtuel créé avec Tiled. Il était encore très basique et vide pour l'instant. mais il a été un excellent point de départ pour apprendre les fonctionnalités de Flutter et les implémenter dans des projets plus avancés. Il m'a également été très utile pour apprendre et comprendre la programmation orientée objet ainsi que le langage de programmation Dart"
        />
        ...
        />
          ...
          name="My wordle"
          src="my_wordle.png"
          descripton="Mon projet 'Wordle' était un jeu de devinettes de mots développé en solo en utilisant TypeScript. Il a été développé en 4 heures et conçu pour être utilisé sur le terminal. Il permettait aux joueurs de deviner un mot caché en saisissant des lettres, et le terminal indiquait si la lettre saisie était correcte, mal placée ou non contenue dans le mot à deviner."
        />
